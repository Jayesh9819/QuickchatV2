...
<body>
    <div class="site_content">
        ...
        <div class="loader-mask1">
            <div id="splash-screen-page" class="position-relative">
                <div class="dots_pattern_img1">
                    <img class="hekko" src="assets/images/dots_pattern.png" alt="dots_pattern">
                </div>
                <div class="splash-screen-logo">
                    <img class="logo_img" src="assets/images/logo.png" alt="logo">
                    <h1 class="AmigoGPT">Amigo GPT</h1>
                    <p class="meets">Where Intelligence Meets Innovation</p>
                </div>
                <div class="dots_pattern_img2">
                    <img class="hekko" src="assets/images/dots_pattern_bottom.png" alt="dots_pattern_bottom">
                </div>
            </div>
        </div>
        <!-- ====================================== Loader Mask End===================================== -->
                                ...
                                <div class="Onboarding-Screen-1-full">
                                    <div class="boarding-title">
                                        <div class="Image-unscreen_main">
                                            <img class="Image-unscreen" src="assets/images/Image.png" alt="Image">
                                            <h2 class="welcome_to_amigo_text">Welcome to Amigo, Great Friend to Chat
                                            </h2>
                                            <p class="proin">Proin molestie pulvinar vitae enim erat morbi eu. Malesuada
                                                eros nisi augue.</p>
                                        </div>
                                    </div>
                                    <div class="d-flex  align-items-center  justify-content-center">
                                        <div class="onboarding-next-btn-slider bottom-fix-btn skip_btn_1">
                        ...
                        <div class="Onboarding-Screen-1 slide2">
                            <div class="">
                                <div class="Onboarding-Screen-1-full">
                                    ...
                                    <div class="d-flex  align-items-center  justify-content-center">
                                        <div class="onboarding-next-btn-slider bottom-fix-btn skip_btn_2">
                                            <a href="javascript:void(0)">Next</a>
                                        </div>
                                    </div>
                                </div>
