                            ...
                            <a class="nav-link <?php if ($_SERVER['REQUEST_URI'] == '/CustCount/index.php/Portal_Cashup_Management') echo 'active';  ?>  " aria-current="page" href="../index.php/Portal_Cashup_Management">
                                <i class="icon" data-bs-toggle="tooltip" title="CashApp Management" data-bs-placement="right">
                                    <svg width="800px" height="800px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 15L19.3714 25.5377C20.5 26.5 22.8282 28 25 26C27.2893 23.8918 25.5 21.5 25 21L17 15" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M4 8H27L38 18" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M9 33L44 33.0193" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M9 18V40H44V18H22.0002" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg> </i>
