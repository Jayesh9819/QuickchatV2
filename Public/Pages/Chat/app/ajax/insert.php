...
if (isset($_POST['message'], $_POST['to_id'])) {
	...
	$messageHtml .= '<button style="background: none; border: none; cursor: pointer; position:relative; bottom:30px;" onclick="setReplyTo(' . $chat_id . ', \'' . addslashes(htmlspecialchars($message)) . '\')"><img src="../uploads/reply.png" style="width:50px;" alt="Reply"></button>';
